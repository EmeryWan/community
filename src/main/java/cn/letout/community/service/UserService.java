...
import cn.letout.community.dao.UserMapper;
import cn.letout.community.entity.LoginTicket;
...
import cn.letout.community.util.MailClient;
...
public class UserService implements CommunityConstant {
    ...
    public Map<String, Object> register(User user) {
        ...
        // 处理请求地址 http://localhost:8080/community/activation/101/code
        String url = domain + contextPath + "/activation/" + user.getId() + "/" + user.getActivationCode();
        context.setVariable("url", url);
        String content = templateEngine.process("/mail/activation", context);  // 邮件模板格式
    ...
    public int activation(int userId, String code) {
        ...
        } else if (user.getActivationCode().equals(code)) {  // 判断激活码
